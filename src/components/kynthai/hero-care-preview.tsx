          ...
          <div
                ...
                <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                              <p className="text-sm font-bold">Kynthai</p>p>
                                              <p className="text-xs text-muted-foreground">Care overview</p>p>
                                  </div>div>
                        </div>div>
                ...
                <div className="mt-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-4 sm:p-5">
                        <div className="flex items-end justify-between gap-3">
                                  <div>
                                              ...
                                              <p className="mt-1 text-sm text-muted-foreground">Today&apos;s progress</p>p>
                                  </div>div>
                                  <p className="text-2xl font-bold tracking-tight">3 <span className="text-sm font-medium text-muted-foreground">of 4</span>span></p>p>
                        </div>div>
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
                        <div className="rounded-2xl border border-border/70 bg-background/70 p-4">
                                  ...
                                  <p className="mt-1 text-sm font-semibold">Next visit tomorrow</p>p>
                                  <p className="mt-1 text-xs text-muted-foreground">10:00 AM · Cardiology</p>p>
                        </div>div>
                        <div className="rounded-2xl border border-border/70 bg-background/70 p-4">
                                  ...
                                  <p className="mt-1 text-sm font-semibold">2 new check-ins</p>p>
                                  <p className="mt-1 text-xs text-muted-foreground">Everyone stays connected</p>p>
                        </div>div>
                </div>div>
